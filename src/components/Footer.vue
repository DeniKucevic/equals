<template>
  <div>
    <b-row
      style="height: auto; bottom: 0; background-color: #e9f6fc"
      align-h="center"
      class="pt-5 footer"
    >
      <b-col
...
export default {
  methods: {
    linkedIn() {
      window.open("https://www.linkedin.com/in/uros-dimitrijevic-9b50b8194/");
    },
    linkedIn2() {
      window.open("https://www.linkedin.com/in/denis-kucevic/");
    },
  },
};
</script>
