  ...
  <div class="wrapper">
    ...
    <b-row  align-h="center" style="height: auto;" class="col1" >
      <b-col xl="7" sm="12" md="12" lg="12" >
        <p>{{$t('oneNews9.p1')}}
          <br /><br /> {{$t('oneNews9.p2')}}<b>{{$t('oneNews9.b1')}}</b>{{$t('oneNews9.p21')}}
          <b>{{$t('oneNews9.b2')}}</b>{{$t('oneNews9.p22')}}<b>{{$t('oneNews9.b3')}}</b>
          <br /><br /> {{$t('oneNews9.p3')}}
          <br /><br /> {{$t('oneNews9.p4')}}
          <br /><br /> {{$t('oneNews9.p5')}}
          <br /><br /> {{$t('oneNews9.p6')}}
          ...
          <br /><br /> {{$t('oneNews9.p8')}}
          <br /><br /> {{$t('oneNews9.p9')}}
          <br /><br /> {{$t('oneNews9.p10')}}
          <br /><br /> {{$t('oneNews9.p11')}}
          <br /><br /> {{$t('oneNews9.p12')}}
          <br /><br /> {{$t('oneNews9.p13')}}
          <br /><br /> {{$t('oneNews9.p14')}}
          </p>
    ...
    <b-row align-h="center" style="height: auto;" class="mt-5">
      <b-col xl="8">
        <b-img :src="require('../assets/vest9.png')" fluid-grow alt="Fluid-grow image"></b-img>  
      </b-col>
    </b-row>
