<template>
  <div class="wrapper">
    ...
    <b-row align-h="center" style="height: auto;" class="mt-5">
      <b-col xl="8">
        <b-img :src="require('../assets/18mart.png')" fluid-grow alt="Fluid-grow image"></b-img>  
      </b-col>
    </b-row>

    <b-row align-h="center" style="height: auto;" class="mt-5">
      <b-col xl="8">
        <b-img :src="require('../assets/18mart2.png')" fluid-grow alt="Fluid-grow image"></b-img>  
      </b-col>
    </b-row>
