    ...
    <b-row align-h="center" style="height: auto" class="col1">
      <b-col xl="7" sm="12" md="12" lg="12">
        <p>
          {{ $t("oneNews2.p1") }}
          <br /><br />
          <span>{{ $t("oneNews2.p2") }}</span> <br /><br />
          {{ $t("oneNews2.p3") }} <br /><br />
          {{ $t("oneNews2.p4") }} <br /><br />
          <span>{{ $t("oneNews2.p5") }}</span> <br /><br />
          {{ $t("oneNews2.p6") }} <br /><br />
          <span>{{ $t("oneNews2.p7") }}</span> <br /><br />
          {{ $t("oneNews2.p8") }} <br /><br />
          {{ $t("oneNews2.p9") }} <br /><br />
          <span>{{ $t("oneNews2.p10") }}</span> <br /><br />
          {{ $t("oneNews2.p11") }} <br /><br />
          <span>{{ $t("oneNews2.p12") }}</span> <br /><br />
          {{ $t("oneNews2.p13") }}
        </p>
      </b-col>
    </b-row>
